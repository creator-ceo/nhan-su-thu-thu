 ...
 * member** (`second-brain-file-ai`), mà kit đó không có `owner-os/` và không có kho của Đoàn.
 ...
 *     sẵn trong `wiki/personal-mission.md` từ trước. Neo tới từng mục qua
 ...
 * (neo sang personal-mission) vì "10 điểm là gì" sống ở trang khác; ở đây định nghĩa từng
